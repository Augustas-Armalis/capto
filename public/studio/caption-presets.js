...
(function () {
  ...
  window.CAPTO_PRESETS = [
    { id: 'inter-bold', name: 'Inter Bold', fontWeight: 700, caseMode: 'none', tracking: -0.02, fill: WHITE, highlightFill: YELLOW, highlightMode: 'color', scale: 116, sizeRatio: 0.046, shadow: true, popular: true, sample: 'keep it simple' },
