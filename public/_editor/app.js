...
async function uploadFile(file) {
  $('.dz-inner', el.dropzone).innerHTML = `<img class="dz-logo" src="/logo.svg"><h1>Uploading…</h1><p>${escapeHtml(file.name)}</p>`;
...
function resetUpload() {
  $('.dz-inner', el.dropzone).innerHTML = `<img class="dz-logo" src="/logo.svg"><h1>Caption your video</h1>
